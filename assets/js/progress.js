window.youAreHere = (function() {
  ...
  var createProgressBar = function() {
    ...
    newProgressBar.style.background = '#ff0000';
    newProgressBar.style.color = '#ff0000';
  ...
  return (function(settings) {
    ...
    progressBar.style.background = settings.color || '#ff0000';
    progressBar.style.color = settings.color || '#ff0000';
